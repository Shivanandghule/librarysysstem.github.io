...
<div class="mySlides fade">
  ...
  <img src="../img/b1.jpeg" style="width:1100px;height:400px">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="../img/b2.jpg" style="width:1100px;height:400px">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="../img/b3.jpeg" style="width:1100px;height:400px">
  <div class="text"></div>
</div>
...
<center><fieldset class=news style="width:75%;border-style: solid;border-width: 4px;width:1100px;">
<?php
	include 'dbcon.php';
...
echo "<table>";
echo "<tr>";
echo "<td rowspan='5'><img src=../img/".$row['book']." style='max-width:220px;height:250px' align='left'> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>";
echo "</tr>";
echo "<tr>";
echo " &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<th>Book Name</th><td>" . $row['Bookname'] . "</td>";
echo "</tr>";
echo "<tr>";
echo "&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <th>Author</th><td>" . $row['Author'] ."</td>";
echo "</tr>";
echo "<tr>";
echo "&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <th>Publication</th><td>" . $row['Publication'] . "</td>";
echo "</tr>";
echo "<tr>";
echo "&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <th>Subject</th><td>" . $row['Category'] . "</td>";
echo "</tr>";
}
echo "</table>";
mysqli_close($con);
...
<center>
<fieldset style="width:1100px;border-style: solid;border-width: 4px; height:400px">
